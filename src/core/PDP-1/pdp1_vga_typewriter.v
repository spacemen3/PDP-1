...
assign current_x = (horizontal_counter >= `h_visible_offset + `h_center_offset + 2'd2 && horizontal_counter < `h_visible_offset_end + `h_center_offset - 2'd3) ? 
                                       horizontal_counter - `h_visible_offset : 11'b0; 
...
always @(posedge clk) begin                                
   ...
   if (current_y[5] && current_y[1] && current_x)     /* Paint even rows background green, to simulate perforated paper and skip every other line within even rows as well */                                                                                                        
