...
# ACDS 20.1 720 win32 2022.07.19.18:06:41
...
# ----------------------------------------
# If PLL_Core is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_Core.vo"
fi
